...
import me.bariahq.bariahqmod.world.WorldTime;
import me.bariahq.bariahqmod.world.WorldWeather;
...
@CommandParameters(description = "Go to the StaffWorld.",
        usage = "/<command> [guest < list | purge | add <player> | remove <player> > | time <morning | noon | evening | night> | weather <off | on | storm>]", aliases = "aw,sw,adminworld")
