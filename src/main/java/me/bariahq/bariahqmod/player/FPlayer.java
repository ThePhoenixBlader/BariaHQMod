...
import me.bariahq.bariahqmod.caging.CageData;
import me.bariahq.bariahqmod.config.ConfigEntry;
import me.bariahq.bariahqmod.freeze.FreezeData;
...
public class FPlayer
{
    ...
    @Getter
    private final BariaHQMod plugin;
    @Getter
    ...
    public FPlayer(BariaHQMod plugin, Player player)
    {
        this(plugin, player.getName(), Ips.getIp(player));
    }

    private FPlayer(BariaHQMod plugin, String name, String ip)
    {
        this.plugin = plugin;
        this.name = name;
        this.ip = ip;
    ...
    public void startArrowShooter(BariaHQMod plugin)
    {
